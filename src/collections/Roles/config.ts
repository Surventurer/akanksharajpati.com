                    ...
                    fields: [
                        {
                            ...
                            fields: [
                                ...
                                { name: 'notFoundPage', type: 'group', label: '404 Page', fields: [{ name: 'read', type: 'checkbox', label: 'Read' }, { name: 'update', type: 'checkbox', label: 'Update' }] },
                            ],
                        },
                    ],
                },
                    ...
                    fields: [
                        {
                            ...
                            fields: [
                                ...
                                { name: 'siteSettings', type: 'group', label: 'Site & Theme Settings', fields: [{ name: 'read', type: 'checkbox', label: 'Read' }, { name: 'update', type: 'checkbox', label: 'Update' }] },
                            ],
                        },
                    ],
                },
