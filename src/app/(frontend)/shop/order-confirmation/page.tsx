...
export default async function OrderConfirmationPage({ searchParams }: OrderConfirmationProps) {
    ...
    return (
        <div className="min-h-[85vh] flex flex-col justify-center items-center bg-background pt-32 pb-20 px-6">
            <div className="max-w-2xl w-full mx-auto text-center">
                ...
                <p className="text-foreground/70 text-lg mb-8 leading-relaxed">
                    We have received your purchase and are preparing it with utmost care.
                </p>
